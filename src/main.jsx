...
import { 
    ...
    serverTimestamp, addDoc, arrayUnion, arrayRemove, deleteDoc, getDocs
...
// 이 파일은 React 표준 렌더링 코드를 포함해야 합니다.
// 최종 렌더링을 DOMContentLoaded 이벤트 리스너 내부에 배치하여 모듈 순서 문제를 해결합니다.
